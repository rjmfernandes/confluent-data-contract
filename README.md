...
This is a fork of:  https://github.com/tomasalmeida/confluent-data-contract
...
**NOTES:**
* V2 insert will fail, as the default compatibility is reviewed and the one we are trying to create breaks it. Error message is similar to:
```
{
  "error_code": 409,
